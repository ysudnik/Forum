...
public class AutoServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(message != null)
        {
            ...
            daoXmlMessages.add(newMsg,"D:\\automessages.xml");
        }
        ...
        for(int i = 0; i < daoXmlMessages.getMessages("D:\\automessages.xml").size(); i++)
        {
            out.println("<h4>" + daoXmlMessages.getMessages("D:\\automessages.xml").get(i).getAuthor().getName()+
                    " : " + daoXmlMessages.getMessages("D:\\automessages.xml").get(i).getText() + "<h4>"
                    +"<h4>"+daoXmlMessages.getMessages("D:\\automessages.xml").get(i).getDate());
        }
...
//        out.println("document.location.href = \"http://localhost:8080/auto\"}");
...
//        out.println("</script>");
        ...
        out.println("<input type=\"hidden\" value=\"" + nick + "\" name=\"nickname\"/>");
        out.println("<input type=\"submit\" value=\"Перейти на sport\"/>");
        out.println("</form>");
        out.println("<hr>");
